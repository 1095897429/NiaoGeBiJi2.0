...
public class HuaweiPushRevicer extends PushReceiver {
    ...
    public void onToken(Context context, String tokenIn, Bundle extras) {
        ...
        //TODO 获取token发送到后台
//        initServiceData(tokenIn);
    }

//    private void initServiceData(String tokenIn) {
//        if (TextUtils.isEmpty(MainApplication.getToken())) {
//            return;
//        }
//        Map<String, Object> map = new HashMap<>();
//        map.put("device_token", tokenIn);
//        map.put("device_token_type", 1);//1 huawei
//
//        Map<String, Object> sercetmap = StringToolKit.MapSercet(map);
//        HttpManager.getApiStoresSingleton().extInit(StringToolKit.map2RequestBody(sercetmap))
//                .subscribeOn(Schedulers.io())
//                .unsubscribeOn(Schedulers.io())
//                .observeOn(AndroidSchedulers.mainThread())
//                .subscribe(new RxCallBack<MyResult<String>>(MainApplication.myApp) {
//                    @Override
