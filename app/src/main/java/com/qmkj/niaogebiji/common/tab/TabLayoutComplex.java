...
package com.qmkj.niaogebiji.common.tab;
 ...
 */
@ViewPager.DecorView
public class TabLayoutComplex extends HorizontalScrollView {
    ...
    /**
     * Gravity used to fill the {@link TabLayoutComplex} as much as possible. This option only takes effect
    ...
    /**
     * Gravity used to lay out the tabs in the center of the {@link TabLayoutComplex}.
     *
     * @see #setTabGravity(int)
     * @see #getTabGravity()
     */
    ...
    public TabLayoutComplex(Context context) {
        this(context, null);
    }

    public TabLayoutComplex(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public TabLayoutComplex(Context context, AttributeSet attrs, int defStyleAttr) {
...
//        mScrollableTabMinWidth = res.getDimensionPixelSize(R.dimen.design_tab_scrollable_min_width);
        mScrollableTabMinWidth = dpToPx(10);
    ...
    /**
     * Returns the current mode used by this {@link TabLayoutComplex}.
     *
     * @see #setTabMode(int)
     */
    @Mode
    ...
    /**
     * The one-stop shop for setting up this {@link TabLayoutComplex} with a {@link ViewPager}.
     * <p>
...
//        if (tab != null) AppLog.i(TAG + "selectTab:tab>>" + tab.getText());
//        if (currentTab != null) AppLog.i(TAG + "selectTab:currentTab>>" + currentTab.getText());
        if (currentTab == tab) {
            if (currentTab != null) {
            ...
            if (currentTab != null) {
//                AppLog.i(TAG + "dispatchTabUnselected:>>updateIndicator:" + updateIndicator);
                dispatchTabUnselected(currentTab);
            }
            mSelectedTab = tab;
            if (tab != null) {
//                AppLog.i(TAG + "dispatchTabSelected:>>updateIndicator:" + updateIndicator);
...
//                mCustomTextView.getPaint().setFakeBoldText(true);
            }
        }
...
//                    AppLog.i(TAG + "setTextColor:" + mTabTextColors);
                    mTextView.setTextColor(mTabTextColors);
//                    mTextView.setTextSize(dpToPx());
                }
    ...
    private class SlidingTabStrip extends LinearLayout {
        ...
        SlidingTabStrip(Context context) {
            ...
            mSelectedIndicatorPaint.setStrokeWidth(dpToPx(3));
        }
     ...
     * necessary calls back to the provided {@link TabLayoutComplex} so that the tab position is
     * kept in sync.
     * <p>
    ...
    public static class TabLayoutOnPageChangeListener implements ViewPager.OnPageChangeListener {
        private final WeakReference<TabLayoutComplex> mTabLayoutRef;
        private int mPreviousScrollState;
        private int mScrollState;

        public TabLayoutOnPageChangeListener(TabLayoutComplex tabLayout) {
        ...
        public void onPageScrolled(final int position, final float positionOffset,
            ...
            final TabLayoutComplex tabLayout = mTabLayoutRef.get();
            if (tabLayout != null) {
...
//            tab.mView.mTextView.getPaint().setFakeBoldText(true);
        ...
        public void onTabUnselected(Tab tab) {
            ...
            tab.mView.mTextView.getPaint().setFakeBoldText(false);
            // No-op
        }
