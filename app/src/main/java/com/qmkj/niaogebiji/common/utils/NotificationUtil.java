...
public class NotificationUtil {
    ...
    public static void OpenNotificationSetting(Context context,OnSettingLitener onSettingLitener,
                                               OnNextLitener mOnNextLitener) {
        if (!isNotificationEnabled(context)) {
//            showSettingDialog(context);
            if (onSettingLitener != null) {
                onSettingLitener.onSetting();
            }
        } else {
    ...
    public interface OnSettingLitener {
        /**
         * 不需要设置通知的下一步
         */
        void onSetting();
    ...
    private OnSettingLitener mOnSettingLitener;

    public void setOnSettingLitener(OnSettingLitener onSettingLitener) {
        mOnSettingLitener = onSettingLitener;
    }
