 ...
 * 描述:
 */
public class AuthorSearchAdapter extends BaseQuickAdapter<AuthorBean.Author, BaseViewHolder> {
    public AuthorSearchAdapter(@Nullable List<AuthorBean.Author> data) {
