...
public class FeatherItemAdapterNew extends BaseQuickAdapter<FeatherProductBean.Productean.ProductItemBean, BaseViewHolder> {
    ...
    public FeatherItemAdapterNew(@Nullable List<FeatherProductBean.Productean.ProductItemBean> data) {
        super(R.layout.activity_feather_item,data);
    ...
    protected void convert(BaseViewHolder helper, FeatherProductBean.Productean.ProductItemBean mBean) {
        ...
        //点击事件
        helper.itemView.setOnClickListener(v -> UIHelper.toFeatherListDetailActivity(mContext,mBean.getId()));
    }
