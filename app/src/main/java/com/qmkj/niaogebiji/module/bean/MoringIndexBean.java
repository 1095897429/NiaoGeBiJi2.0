 ...
 * 描述:早报首页新实体
 */
public class MoringIndexBean extends BaseBean {

    private MoringBean morning_article;

    public MoringBean getMorning_article() {
        return morning_article;
    }

    public void setMorning_article(MoringBean morning_article) {
        this.morning_article = morning_article;
    }
