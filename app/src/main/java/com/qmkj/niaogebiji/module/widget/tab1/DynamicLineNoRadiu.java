...
public class DynamicLineNoRadiu extends View {
    ...
    public DynamicLineNoRadiu(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs,0);
    }

    public DynamicLineNoRadiu(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
