 ...
 * 描述:没有圆角的指示器
 */
public class DynamicLineNoRadiu3 extends View {
    ...
    public DynamicLineNoRadiu3(Context context) {
        this(context,null);
    }

    public DynamicLineNoRadiu3(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs,0);
    }

    public DynamicLineNoRadiu3(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
