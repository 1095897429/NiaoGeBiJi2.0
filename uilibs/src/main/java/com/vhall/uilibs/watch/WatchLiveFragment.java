...
public class WatchLiveFragment extends Fragment implements WatchContract.LiveView, View.OnClickListener {
    ...
    private LinearLayout no_course_part;
    private LinearLayout has_course_part;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root = inflater.inflate(R.layout.watch_live_fragment_2, container, false);
        initView(root);
        reFreshView();
        return root;
    }
    ...
    private void initView(View root) {
        ...
        no_course_part = (LinearLayout) root.findViewById(R.id.no_course_part);
        has_course_part = (LinearLayout) root.findViewById(R.id.has_course_part);
...
//        .setCacheStuffer(new BackgroundCacheStuffer())  // 绘制背景使用BackgroundCacheStuffer
    ...
    public RelativeLayout getWatchLayout() {
        Log.d("tag","getWatchLayout " + mContainerLayout.getParent());
    ...
    public void setPlayPicture(boolean state) {
        if (state) {
            clickStart.setImageResource(R.mipmap.live_to_pause);
        } else {
            clickStart.setImageResource(R.mipmap.live_to_play);
        }
    }
...
//                mPresenter.onSwitchPixel(WatchLive.DPI_UHD);
    ...
    public void onDocumentCloseEvent(DocumentCloseEvent event){
        ...
        if (type.equals(TYPE_SWITCHOFF)) {
            ...
            clickStart = (ImageView) no_course_part.findViewById(R.id.click_rtmp_watch);
            clickStart.setOnClickListener(this);
            clickOrientation = (ImageView) no_course_part.findViewById(R.id.click_rtmp_orientation);
            clickOrientation.setOnClickListener(this);
