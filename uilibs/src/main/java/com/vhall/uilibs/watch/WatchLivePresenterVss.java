...
public class WatchLivePresenterVss implements WatchContract.LivePresenter, ChatContract.ChatPresenter {
        ...
        public void onEvent(String event, String type, String cid) {
            ...
            if (event.equals(KEY_OPERATE)) {
                if (type.equals(TYPE_ACTIVE)) {
                    ...
                    if(mCloseDocumentListener != null){
                        mCloseDocumentListener.openOrClose(type);
                    }
                    EventBus.getDefault().post(new DocumentCloseEvent(type));
   ...
   public class MyLister implements IVssMessageLister {
    ...
    //关闭文档的接口
    public closeDocumentListener mCloseDocumentListener;

    public void setCloseDocumentListener(closeDocumentListener closeDocumentListener) {
        mCloseDocumentListener = closeDocumentListener;
    }
}
