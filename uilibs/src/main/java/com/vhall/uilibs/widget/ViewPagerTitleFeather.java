...
public class ViewPagerTitleFeather extends LinearLayout {
    ...
    public void setCurrentItem(int index) {
        for (int i = 0; i < textViews.size(); i++) {
            if (i == index) {
                textViews.get(i).setTextColor(getResources().getColor(R.color.text_news_title_color111));
                textViews.get(i).setTextSize(18);
                textViews.get(i).setTypeface(typeface);
            } else {
                textViews.get(i).setTextColor(getResources().getColor(R.color.text_news_tag_color111));
    ...
    private void createTextViews(String[] titles) {
        ...
        for (int i = 0; i < titles.length; i++) {
            ...
            textView.setTextColor(getResources().getColor(R.color.text_news_tag_color111));
